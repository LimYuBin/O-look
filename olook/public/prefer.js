...
function showTab(n) {
  ...
  if (0 <= n < (x.length -1)) {
    ...
    //index 색상 변경..
    if(n==1) {
      document.getElementById("profile_info").style.background = "white";
      document.getElementById("profile_info").style.color = "black";
    ...
    if(n==2) {
      ...
      document.getElementById("pc_info").style.background = "white";
      document.getElementById("pc_info").style.color = "black";
    ...
    if(n==3) {
      ...
      document.getElementById("ps_info").style.background = "white";
      document.getElementById("ps_info").style.color = "black";
    ...
    if(n==4) {
      ...
      document.getElementById("pb_info").style.background = "white";
      document.getElementById("pb_info").style.color = "black";
